export default function TermsConditions() {
    return (
        <div className="flex flex-col gap-10">
            <h1 className="text-5xl">Şartlar ve Koşullar</h1>
            ...
            <p className="w-9/10">
                Tempora doloribus molestiae repellat pariatur nisi, harum officiis tempore esse rem ex est animi itaque iste a neque atque alias ipsam labore. Qui sed aspernatur perspiciatis dolores, eius repellat atque.
                Soluta laborum earum dignissimos facilis incidunt ducimus blanditiis, explicabo totam ipsum hic itaque atque illum quia, tempore animi! Ex eaque facilis incidunt blanditiis voluptas fuga dicta ab eveniet assumenda veniam!
            </p>
            <p className="w-9/10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores mollitia minus unde ipsa, sed aperiam temporibus commodi? Quae, quasi. Delectus, recusandae quaerat nihil quasi quisquam libero blanditiis enim doloremque consequuntur?
                Ad atque doloremque, reprehenderit in esse at aut eum perferendis nisi tempore, obcaecati, fugiat temporibus molestias similique accusantium distinctio maiores nesciunt voluptate soluta aliquid ducimus nostrum. Molestiae fuga voluptatem iure?
            </p>
